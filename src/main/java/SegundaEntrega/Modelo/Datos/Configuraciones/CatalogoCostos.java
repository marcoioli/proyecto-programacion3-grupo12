...
public final class CatalogoCostos {
    ...
    private double costoConsultaMedica = 0; // <-- ATRIBUTO AÑADIDO

    // Factores para HabPrivada
    private double factorPrivadaDia1 =1.0 ;
    private double factorPrivadaHasta5Dias = 1.3;
    private double factorPrivadaMasDe5Dias = 2.0;

    // Parámetro de potencia para TI
    ...
    public double getCostoConsultaMedica() { return costoConsultaMedica; } // <-- GETTER AÑADIDO
    ...
    /**
     * Establece el costo base de una consulta médica.
     * @param valor costo en pesos
     * @return esta instancia para encadenar llamadas
     */
    public CatalogoCostos setCostoConsultaMedica(double valor) { // <-- SETTER AÑADIDO
        this.costoConsultaMedica = valor;
        return this;
    }
